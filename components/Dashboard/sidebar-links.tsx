...
import { useCurrenUsertRole } from "@/hooks/use-current-role";
...
export default function SidebarLinks() {
  ...
  const roleLinks:any = {
    ...
    DOCTOR: [
      ...
      { title: "patients", href: "/dashboard/doctors/patients", icon: PiUsersThreeBold },
    ...
    ADMIN: [
      ...
      { title: "patients", href: "/dashboard/admin/patients", icon: PiUsersThreeBold },
